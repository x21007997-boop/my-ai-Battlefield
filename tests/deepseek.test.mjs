...
test('DeepSeek proxy validates and parses structured council output', async () => {
  ...
  const request = new Request('http://local/api/ai/council', { method: 'POST', headers: { 'content-type': 'application/json' }, body: JSON.stringify({ world: { turn: 3, metrics: {}, cities: {}, flags: [], history: [] }, question: '如何处置？' }) });
