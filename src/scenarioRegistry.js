...
export const SCENARIOS = [
  { manifest: hgManifest, initialWorld: hgInitialWorld, cities: hgCities, characters: hgCharacters, council: hgCouncil, events: hgEvents, endings: hgEndings, reports: hgReports },
  { manifest: yzManifest, initialWorld: yzInitialWorld, cities: yzCities, characters: yzCharacters, council: yzCouncil, events: yzEvents, endings: yzEndings, reports: yzReports },
];
