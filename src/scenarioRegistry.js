...
export const SCENARIOS = [
  { manifest: hgManifest, initialWorld: hgInitialWorld, cities: hgCities, characters: hgCharacters, events: hgEvents, endings: hgEndings, reports: hgReports },
  { manifest: yzManifest, initialWorld: yzInitialWorld, cities: yzCities, characters: yzCharacters, events: yzEvents, endings: yzEndings, reports: yzReports },
];
