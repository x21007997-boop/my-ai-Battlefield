    ...
    return (
      <main className="scenario-library">
        ...
        <section className="scenario-grid">
          <article className="scenario-card jade battle-game-card">
            <div className="scenario-number">战役 01</div>
            <small>即时战争 · 认知指挥</small>
            <h2>长平决战前</h2>
            <p>以历史背景为起点，在沙盘上指挥秦军。命令有延迟，敌情来自侦报，真假需要由你判断。</p>
            <div className="scenario-meta"><span>实时推演</span><span>情报战</span><span>沙盘指挥</span></div>
            <footer>
              <div><b>正式战役关卡</b><span>第一张可玩战场</span></div>
              <div className="scenario-card-actions"><a className="primary battle-entry-link" href="/?battle=changping">进入战役 <CaretRight size={18} /></a></div>
            </footer>
          </article>
        ...
        <div className="library-note">战役内容、历史资料与规则内核分离 · 长平是当前第一张正式可玩战场 · 历史争议仍会在关卡中明确标注</div>
