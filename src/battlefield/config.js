...
export const BATTLEFIELD_CONFIG = Object.freeze({
  ...
  defaults: Object.freeze({
    ...
    aiVerificationDelaySeconds: 5,
    aiWeakReliabilityThreshold: 0.6,
    aiReliabilityPenalty: 0.25,
    taskReportDelaySeconds: 3,
  ...
  postureCombatFactors: Object.freeze({
    standard: 1,
    hold: 1.04,
    guard: 1.03,
    cover: 1.1,
