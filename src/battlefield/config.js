...
export const BATTLEFIELD_CONFIG = Object.freeze({
  ...
  defaults: Object.freeze({
    ...
    scoutCooldownSeconds: 0,
    strategyExposureDelaySeconds: 3,
    strategyFailureReliabilityPenalty: 0.15,
    directCommandDelaySeconds: 0,
    messengerBaseDelaySeconds: 1,
    messengerRouteTravelFactor: 0.25,
    messengerFallbackDelaySeconds: 4,
  ...
  resourceLabels: Object.freeze({
    intelligencePoints: '情报点',
    scoutTeams: '侦察队',
    deceptionAssets: '计策资源',
  }),
